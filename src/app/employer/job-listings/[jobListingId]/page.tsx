    ...
    <div className="space-y-6 max-w-6xl mx-auto p-4 @container">
      <div className="flex items-center justify-between gap-4 @max-4xl:flex-col @max-4xl:items-start">
        ...
        <div className="flex items-center gap-2 empty:-mt-4">
          <AsyncIf
            condition={() => hasCustomPermission("org:job_listings:update")}
          >
          ...
          <AsyncIf
            condition={() => hasCustomPermission("org:job_listings:delete")}
          >
            <ActionButton
              variant="destructive"
...
function StatusUpdateButton({
  ...
  return (
    <AsyncIf
      condition={() => hasCustomPermission("org:job_listings:change_status")}
    >
...
async function Applications({ jobListingId }: { jobListingId: string }) {
  ...
  return (
    <ApplicationTable
      ...
      canUpdateRating={await hasCustomPermission(
        "org:job_listing_applications:change_rating"
      )}
      canUpdateStage={await hasCustomPermission(
